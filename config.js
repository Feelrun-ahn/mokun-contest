// ============================================================
//  ⚙️ 여기 두 줄만 바꾸면 사이트가 동작합니다.
//
//  Supabase 대시보드 → 왼쪽 아래 Project Settings → API (또는 Data API)
//    - Project URL      →  SUPABASE_URL
//    - anon public key  →  SUPABASE_ANON_KEY
//
//  ※ anon public 키는 공개돼도 되는 키입니다. (보안은 데이터베이스가 막아줍니다)
//  ※ service_role 키는 절대 넣지 마세요!
// ============================================================

const SUPABASE_URL = 'https://whecdbxwmtlxdiepfpvp.supabase.co';
